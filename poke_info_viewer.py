...
lbl_type_value.grid(row=0, column=1)
...
bar_hp = ttk.Progressbar(frm_btm_right, oritent=HORIZONTAL, length=200, maximum=255)
bar_hp.grid(row=0, column=1)

lbl_attack = ttk.Label(frm_btm_right, text='Attack:')
lbl_attack.grid(row=0, column=0)
bar_attack = ttk.Progressbar(frm_btm_right, oritent=HORIZONTAL, length=200, maximum=255)
bar_attack.grid(row=0, column=1)

lbl_defense = ttk.Label(frm_btm_right, text='Defense:')
lbl_defense.grid(row=0, column=0)
bar_defense = ttk.Progressbar(frm_btm_right, oritent=HORIZONTAL, length=200, maximum=255)
bar_defense.grid(row=0, column=1)

lbl_special_attack = ttk.Label(frm_btm_right, text='Special Attack:')
lbl_special_attack.grid(row=0, column=0)
bar_special_attack = ttk.Progressbar(frm_btm_right, oritent=HORIZONTAL, length=200, maximum=255)
bar_special_attack.grid(row=0, column=1)

lbl_special_defense = ttk.Label(frm_btm_right, text='Defense:')
lbl_special_defense.grid(row=0, column=0)
bar_special_defense = ttk.Progressbar(frm_btm_right, oritent=HORIZONTAL, length=200, maximum=255)
bar_special_defense.grid(row=0, column=1)

lbl_speed = ttk.Label(frm_btm_right, text='Defense:')
lbl_speed.grid(row=0, column=0)
bar_speed = ttk.Progressbar(frm_btm_right, oritent=HORIZONTAL, length=200, maximum=255)
bar_speed.grid(row=0, column=1)
#TODO: Add next 3 stats
